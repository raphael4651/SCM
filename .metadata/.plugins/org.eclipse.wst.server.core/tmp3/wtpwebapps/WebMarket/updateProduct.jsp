			...
			<div class="col-md-7">
				<form name="newProduct" action="./processUpdateProduct.jsp" class="form-horizontal" method="post" enctype="multipart/form-data">
					<div class="form-group row">
						<label class="col-md-2">상품코드</label>
						<div class="col-md-3">
					...
					<div class="form-group row">
						<label class="col-md-2">상세설명</label>
						<div class="col-md-5">
					...
					<div class="form-group row">
						...
						<div class="col-sm-5">
							<input type="radio" 
							       name="condition" 
							       value="New" <%if(rs.getString("p_condition") != null && rs.getString("p_condition").equals("New")){%> checked <%}%>>신규제품
							<input type="radio" 
							       name="condition" 
							       value="Old" <%if(rs.getString("p_condition") != null && rs.getString("p_condition").equals("Old")){%> checked <%}%>>중고제품
							<input type="radio" 
							       name="condition" 
							       value="Refurbished" <%if(rs.getString("p_condition") != null && rs.getString("p_condition").equals("Refurbished")){%> checked <%}%>>재생제품
						</div>
</div>
					
					<div class="form-group row">
						<label class="col-md-2">이미지</label>
						<div class="col-md-5">
